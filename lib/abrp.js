...
function removeTelemetry(count) {
  // Remove 'count' elements from the beginning of the telemetryToSend array
...
/**
 * Handles subscribing or unsubscribing to vehicle state events.
...
function test232() {
  JSON.print(OvmsMetrics.Value('v.e.gear'))
  JSON.print(metricMap)

  // sendBulkTelemetry()
  //Console.debug(encodeURIComponent(JSON.stringify(createBulkPost())))
}
